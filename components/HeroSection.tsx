...
export default function HeroSection() {
  return (
    <section className="relative w-full h-[450px] flex items-center justify-center text-center text-white overflow-hidden bg-gradient-to-r from-orange-500 to-blue-500">
      {/* Optional subtle overlay for text readability */}
      {/* <div className="absolute inset-0 bg-black opacity-20 z-10"></div> */}

      <div className="relative z-20 p-4 pb-12 max-w-3xl">
